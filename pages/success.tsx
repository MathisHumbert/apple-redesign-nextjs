...
function Success({ products }: Props) {
  ...
  const subtotal = products.reduce(
    (acc, curr) => acc + curr.price.unit_amount / 100,
    0
  );
        ...
        <section className='order-2 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44'>
          ...
          <div className='mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14'>
            ...
            <div className='pt-3 text-sm'>
              <p className='font-medium text-gray-6 00'>
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <div className='relative flex h-16 w-16 items-center justify-center rounded-md border border-gray-300 bg-[#F1F1F1] text-sm text-white'>
                        ...
                        <div className='absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center rounded-full bg-[gray] text-sm'>
                          {product.quantity}
                        </div>
                      </div>
